...
nlsave('Graphene_eph-line.hdf5', bulk_configuration)
...
# -------------------------------------------------------------
k_a = numpy.linspace(1.66344, 1.71744, 20)
k_b = numpy.linspace(0, 0, 1)
...
nlsave('Graphene_eph-line.hdf5', electron_phonon_coupling)
